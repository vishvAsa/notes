...
## Intro
- It is an alternative to YAML and JSON. It aims to be more human friendly than JSON and simpler that YAML. TOML is designed to map unambiguously to a hash table. 
...
## Sources
- [learnXinY](https://learnxinyminutes.com/docs/toml/)