...
- Tocharians and shaka-s + East Asian (Hunnic) input → uighur (with significant genetic input).
...
## Loss to Altaic people
Starting with the Huns, the steppe Iranics more and more shifted eastwards (genetically). See ethnogenesis of Turks for details.
