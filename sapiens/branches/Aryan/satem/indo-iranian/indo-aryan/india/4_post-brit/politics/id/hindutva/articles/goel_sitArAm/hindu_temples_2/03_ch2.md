...
NaiNasî has included in his chapter on the Rudramãla a poem written in its praise by Lalla BhaTTa.^([9](#9)) The first two stanzas which describe the architecture and sculptures of the temple are as follows:
