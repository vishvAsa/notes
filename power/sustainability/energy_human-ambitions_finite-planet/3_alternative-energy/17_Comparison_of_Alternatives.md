...
Transportation needs are hard to satisfy. Together with the fact that oil production will peak before natural gas or coal, transportation may appear as the foremost problem to address. Electric cars are an obviousalbeit expensive solution. Besides being unclear how we might all afford11 electric cars, the technology has a number of drawbacks relative
...
13:
...
translating to about 10-15 GW of average power production added per year
